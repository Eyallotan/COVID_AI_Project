...
def print_y_test_vs_y_predict(Y_test, DT_regressor_results, RF_regressor_results):
    x_ax = range(len(Y_test[50:90]))
    plt.plot(x_ax, Y_test[50:90], linewidth=1, label="Original")
    plt.plot(x_ax, DT_regressor_results[50:90], linewidth=1.1, label="DecisionTreeRegressor Predicted")
    plt.plot(x_ax, RF_regressor_results[50:90], linewidth=1.1, label="RandomForestRegressor Predicted")
